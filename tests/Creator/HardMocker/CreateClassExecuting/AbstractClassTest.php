...
class AbstractClassTest extends TestCase
{
    public function testRun(): void
    {
        ...
        $classManager = HardMocker::createForCode($phpCode);
    ...
    public function testAbstractRealisationWithoutMock(): void
    {
        ...
        $classManagerAbstract = HardMocker::createForCode($phpCodeForAbstractClass);
    ...
    public function testAbstractRealisationWithMock(): void
    {
        ...
        $classManagerAbstract = HardMocker::createForCode($phpCodeForAbstractClass);
        $classManagerChild = HardMocker::createForCode($phpCodeForChildClass);
