...
class AutoloaderTest extends TestCase
{
    ...
    public function testExecutingClassLoadCreateMockOk(): void
    {
        ...
        self::assertTrue($autoloader->executingClassLoadCreateMock(dirname(__DIR__, 2) . '/examples-ru/classes/AbstractClass.php', false));
        self::assertTrue($autoloader->executingClassLoadCreateMock(dirname(__DIR__, 2) . '/examples-ru/classes/BasicClass.php', true));
        self::assertTrue($autoloader->executingClassLoadCreateMock(dirname(__DIR__, 2) . '/examples-ru/classes/ClassInterface.php', true));
    }
    ...
    public function testExecutingClassLoadCreateMockFail(): void
    {
        ...
        self::assertFalse($autoloader->executingClassLoadCreateMock('path_not_found', false));

        $this->expectException(PhpMockerAutoloaderExceptionInterface::class);

        $autoloader->executingClassLoadCreateMock('path_not_found', true);
    }
    ...
    private function createMockAutoloaderForTestExecutingClassLoad(string $driverReturnPath): Autoloader
    {
        return new class($driverReturnPath) extends Autoloader {
            ...
            public function executingClassLoadCreateMock(string $classPath, bool $ifFailToException): bool
            {
    ...
    private function createMockAutoloaderForTestExecutingClassLoadCreateMock(): Autoloader
    {
        return new class() extends Autoloader {
            ...
            public function executingClassLoadCreateMock(string $classPath, bool $ifFailToException): bool
            {
                return parent::executingClassLoadCreateMock($classPath, $ifFailToException);
            }
        };
    }
}
