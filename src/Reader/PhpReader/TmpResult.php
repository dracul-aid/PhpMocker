 ...
 *
 * Оглавление:
 * @see TmpResult::$namespace - Текущее читаемое пространство имен
 * @see TmpResult::$uses - Массив со списком конструкций use для используемых классов, функций или констант
 * @see TmpResult::$schemeClass - Схема текущего читаемого класса или NULL, если чтение происходит вне класса
 * @see TmpResult::$codeBlockDeep - Указывает на текущую глубину вложений в фигурные скобки
 * @see TmpResult::$codeBlockForClassDeep - Уровень вложенности фигурных скобок с которого начато чтение кода класса
 * @see TmpResult::$attributes - Массив схем накопленных атрибутов
 */
class TmpResult
{
    /**
