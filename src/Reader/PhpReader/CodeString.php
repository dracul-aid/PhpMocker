 ...
 *
 * Оглавление:
 * @see CodeString::$phpCode - Еще не обработанный PHP код
 * @see CodeString::$charFirst - Первый символ прочитанный из PHP кода
 * @see CodeString::$charSecond - Второй символ прочитанный из PHP кода
 * @see CodeString::read() - Прочтет очередной символ из необработанного кода
 * @see CodeString::charClear() - Очистка первого и второго прочитанного символа неразобранного кода
 * @see CodeString::isWordStart() - Проверит предположение, что в данный момент идет чтение определенной строки (например, ключевого слова)
 */
class CodeString
{
    /**
