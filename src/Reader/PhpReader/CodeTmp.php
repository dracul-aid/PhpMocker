 ...
 *
 * Оглавление:
 * @see CodeTmp::$result - Строка с накопленным временным результатом
 * @see CodeTmp::$lastChar - Последний символ в накопленных результатах
 * @see CodeTmp::set() - Заменит значение для результата
 * @see CodeTmp::addChar() - Добавит к результату новый символ
 * @see CodeTmp::addString() - Добавит к результату строку и вычислит последний символ
 * @see CodeTmp::resultClear() - Очистит накопленные результаты
 * @see CodeTmp::resultClearAndSetSpase() - Очистит накопленные результаты и в результаты запишет пустую строку (но не в последний символ)
 */
class CodeTmp
{
    /**
