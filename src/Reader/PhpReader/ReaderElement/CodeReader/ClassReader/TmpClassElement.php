 ...
 * @see TmpClassElement::$scheme - Хранит объект схему, для читаемого элемента класса (метода, константы...)
 * @see TmpClassElement::$view - Область видимости читаемого элемента
 * @see TmpClassElement::$writeFor - Для какого свойства схемы элемента класса в данный момент идет запись
 * @see TmpClassElement::$isStatic - Является ли читаемый элемент "статичным"
 * @see TmpClassElement::$isFinal - Является ли читаемый элемент "финальным"
 * @see TmpClassElement::$isAbstract - Является ли читаемый элемент "абстрактным"
 * @see TmpClassElement::$isReadonly - Является ли читаемый элемент "только для чтения"
 * @see TmpClassElement::clear() - Очищает данные накопленные для элемента
 * @see TmpClassElement::getView() - Вернет уровень видимости для элемента
 */
