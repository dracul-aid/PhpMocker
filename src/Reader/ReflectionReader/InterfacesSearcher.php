...
/**
 * Класс, для получения списка интерфейсов из рефлексии (интерфейсов конкретного класса, без интерфейсов его родителей)
 * Основная функция @see InterfacesSearcher::exe()
 */
