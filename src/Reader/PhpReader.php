 ...
 * @see PhpReader::$codeString - Объект с еще не обработанным кодом
 * @see PhpReader::$codeTmp - Объект с накапливаемой строкой кода
 * @see PhpReader::$tmpResult - Объект для хранения временных результатов
 * @see PhpReader::$readWithStrings - Нужно ли "временный результат" помещать строки
 * @see PhpReader::$result - Для накопления ответа (список найденных схем классов)
 *
