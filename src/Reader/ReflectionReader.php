...
/**
 * Читает с помощью PHP рефлексии класс и создает его схему
...
class ReflectionReader
{
     ...
     *
     * @param   AbstractBasicScheme       $scheme       Схема в которую будут записаны атрибуты
     * @param   \ReflectionAttribute[]    $attributes   Список атрибутов
     *
     * @return  void
     */
    public static function readAttributesFor(AbstractBasicScheme $scheme, array $attributes): void
    {
