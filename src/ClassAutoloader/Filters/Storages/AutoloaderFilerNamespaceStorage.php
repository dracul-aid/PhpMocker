 ...
 *
 * Оглавление:
 * @see AutoloaderFilerClassNameStorage::add() - Добавить в фильтр новое пространство имен
 * @see AutoloaderFilerClassNameStorage::addList() - Добавить в фильтр новые пространства имен из массива
 * @see AutoloaderFilerClassNameStorage::remove() - Удалит из фильтра пространство имен
 * @see AutoloaderFilerClassNameStorage::removeList() - Удалит из фильтра пространства имен переданные в массиве
 * @see AutoloaderFilerClassNameStorage::in() - Проверит, есть ли пространство имен в хранилище
 * @see AutoloaderFilerClassNameStorage::getStorageData() - Вернет массив со всеми пространствами имен хранимыми в хранилище
 */
