 ...
 *
 * Оглавление:
 * @see Tools::mockName() - Вернет строку для использования в качестве имен мок элементов
 * @see Tools::mockClassName() - Создаст имя для мок-класса
 * --- Имена методов для обращения к мок-объектам
 * @see Tools::methodPropertyGet() - Получение значения свойства
 * @see Tools::methodPropertySet() - Запись значения в свойство
 * @see Tools::methodCall() - Вызов статического метода
 * --- Имена методов для обращения к мок-классам
 * @see Tools::methodConstGet() - Получение значения константы
 * @see Tools::methodStaticPropertyGet() - Получение значения статического свойства
 * @see Tools::methodStaticPropertySet() - Запись значения в статическое свойство
 * @see Tools::methodStaticCall() - Вызов статического метода
 */
class Tools
{
    /**
