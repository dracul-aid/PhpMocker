 ...
 *
 * Оглавление:
 * @see AttributeScheme::$name - Имя атрибута
 * @see AttributeScheme::$namespace - Пространство имен
 * @see AttributeScheme::$innerPhpCode - Код значения атрибута
 * @see AttributeScheme::getFullName() - Вернет полное имя атрибута (т.е. включая пространство имен)
 * @see AttributeScheme::setFullName() - Установит имя атрибута (включая пространство имен)
 */
class AttributeScheme
{
     ...
     */
    protected null|AbstractBasicScheme $ownerScheme;

    /**
     * Создание схемы класса
     *
     * @param   null|AbstractBasicScheme   $scheme   Объект-схема для которой был создан атрибут
     * @param   string               $name     Полное имя атрибута (включая пространство имен)
     */
    public function __construct(null|AbstractBasicScheme $scheme, string $name)
    {
