 ...
 *
 * Оглавление:
 * @see AbstractBasicScheme::$name - Имя элемента
 * @see AbstractBasicScheme::$innerPhpCode - Внутренний код элемента (PHP код)
 * @see AbstractBasicScheme::$attributes - Список атрибутов
 */
abstract class AbstractBasicScheme
{
    /**
     * Имя элемента
     */
