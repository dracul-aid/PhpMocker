 ...
 *
 * Оглавление:
 * @see UseScheme::$type - Тип конструкции (т.е. она для класса, константы или функции)
 * @see UseScheme::$namespace - Пространство имен (пустая строка для глобального пространства имен)
 * @see UseScheme::$name - Имя элемента
 * @see UseScheme::$alias - Если элемент указан с псевдонимом (конструкция name AS alias)
 * @see UseScheme::getFullName() - Вернет полное имя
 * @see UseScheme::generatePhpCode() - Сгенерирует PHP код для конструкции use
 */
class UseScheme
{
    /**
