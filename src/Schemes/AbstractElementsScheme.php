 ...
 *
 * Оглавление:
 * @see AbstractElementsScheme::$view - Уровень видимости (public, protected...)
 * @see AbstractElementsScheme::$isDefine - Элемент определен (переопределен) в этом текущем классе схемаПроверит, является ли элемент public
 * @see AbstractElementsScheme::isPublic() - Проверит, является ли элемент public
 * @see AbstractElementsScheme::isProtected() - Проверит, является ли элемент protected
 * @see AbstractElementsScheme::isPrivate() - Проверит, является ли элемент private
 */
