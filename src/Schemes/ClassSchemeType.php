 ...
 * @see ClassSchemeType::canUseFinal() - Может ли использоваться с ключевым словом final
 * @see ClassSchemeType::canUseReadonly() - Может ли использоваться с ключевым словом readonly
 * @see ClassSchemeType::canUseExtends() - Может ли использовать классы-родители
 * @see ClassSchemeType::canUseProperties() - Может ли использовать свойства
 * @see ClassSchemeType::canUseReadonly() - Может ли использовать свойство readonly
 */
