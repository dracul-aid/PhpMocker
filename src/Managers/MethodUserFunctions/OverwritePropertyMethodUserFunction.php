 ...
 *
 * Оглавление:
 * @see self::$setPropertyData - Массив, для перезаписи свойств объекта
 * @see self::$stopMock - Нужно ли прекратить дальнейшее выполнение мок-кода
 * @see self::$stopMethod - Нужно ли прекратить выполнение функции (т.е. вернуть мок-результат)
 * @see self::$returnData - Установленный для ответа функции мок-результат
 */
