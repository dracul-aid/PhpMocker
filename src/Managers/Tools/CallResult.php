 ...
 *
 * Оглавление:
 * @see CallResult::$isCanReturn - Указание, что функция не должна выполняться, а должна вернуть заготовленный ответ
 * @see CallResult::$canReturnData - Какие данные должен вернуть функция
 * @see CallResult::$rewriteArguments - Массив, с значениями для перезаписи аргументов метода
 */
class CallResult
{
    /**
