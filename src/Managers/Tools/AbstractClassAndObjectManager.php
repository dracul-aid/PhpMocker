 ...
 *
 * Оглавление:
 * @see AbstractClassAndObjectManager::$methodManagers - Массив с менеджерами мок-методов
 * @see AbstractClassAndObjectManager::getMethodManager() - Вернет менеджер мок-метода
 * @see AbstractClassAndObjectManager::$mockMethodNames - Список имен методов класса, для которых можно получить "мок-метод"
 * @see AbstractClassAndObjectManager::getDriver() - Вернет имя класса, с помощью которого был создан мок-класс
 * @see AbstractClassAndObjectManager::getToClass() - Вернет имя мок-класса, для которого создан менеджер
 * @see AbstractClassAndObjectManager::getToClassScheme() - Вернет схему класса, для которого создан менеджер (если ее нет, создаст ее)
 * @see AbstractClassAndObjectManager::getProperty() - Получение значения свойства (в том числе и protected и private)
 * @see AbstractClassAndObjectManager::setProperty() - Установка значения свойства или списка свойств (в том числе и protected и private)
 * @see AbstractClassAndObjectManager::callMethod() - Вызов метода (в том числе и protected и private)
 *
